...
import 'package:project/page/qr_create_page.dart';
import 'package:project/page/qr_scan_page.dart';
import 'package:project/widget/button_widget.dart';

import 'forPatient/loginPage1.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              ButtonWidget(
                text: 'Login',
                onClicked: () => Navigator.of(context).push(MaterialPageRoute(
                  builder: (BuildContext context) => myProject(),
                )),
              ),
            ],
          ),
