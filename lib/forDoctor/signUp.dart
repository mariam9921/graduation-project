...
import 'package:project/forDoctor/loginPagett.dart';
...
final doctorReference = FirebaseDatabase.instance.reference().child('Doctor');
...
class _SignUpPageState extends State<signUp> {
  ...
  TextEditingController _guildCardController = TextEditingController();
  ...
  Widget phoneTextFormField() {
    return TextFormField(
      decoration:
          InputDecoration(labelText: 'Phone', prefixIcon: Icon(Icons.email)),
      keyboardType: TextInputType.emailAddress,
  ...
  Widget guildCardTextFormField() {
    return TextFormField(
      decoration: InputDecoration(
          labelText: 'GuildCard', prefixIcon: Icon(Icons.article_outlined)),
      keyboardType: TextInputType.text,
      controller: _guildCardController,
    );
  }
    ...
    return RaisedButton(
      ...
      onPressed: () {
        print({
          ...
          'guidcard': _guildCardController.text ?? "",
        ...
        personReference.push().set({
          ...
          doctorReference.push().set({
            'guidcard': _guildCardController.text ?? "",
            'phone': _phoneController.text ?? "",
            'specialization': _specializationController.text ?? "",
          }).then((value) => Navigator.push(
              context, MaterialPageRoute(builder: (context) => loginPagett())));
        });
      },
    );
